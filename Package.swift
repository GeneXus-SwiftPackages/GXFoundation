...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.5.xcframework.zip",
			checksum: "9d642599e03783513db6f2370c9347b78d1b1aeddf8787e32cdd23fd4e5793e4"
		)
	]
)