...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230525143554.xcframework.zip",
			checksum: "16531c636c7055d747da96c781c41ea9e2fb4ad65e71e451be521e9c818f88b0"
		)
	]
)