...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230516174834.xcframework.zip",
			checksum: "17539405164d1d36bcfe281883391e732c2de4c95f6398e2f516d08dad571aff"
		)
	]
)