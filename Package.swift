...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230717172207.xcframework.zip",
			checksum: "e7bec38b40bbeddd12763fc6e2b7f11278cfa1695d8abbd712154c8e2c507033"
		)
	]
)