...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230606141441.xcframework.zip",
			checksum: "53e99670d890d16feae40c04967e97451e1704e8cbfb42a4bf49f6cb4d704e06"
		)
	]
)