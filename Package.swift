...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFoundation-1.1.0-rc.3.xcframework.zip",
			checksum: "558631c33a3fce936e9a37c95d10ae20e9ea2623b5c281b9dc62e87dcf6822de"
		)
	]
)