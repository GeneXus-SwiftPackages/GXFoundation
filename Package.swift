...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230328171001.xcframework.zip",
			checksum: "a5b6bda19c1ef116474f40749def70b07c63d448db6882d3adfebdf4bbbfa565"
		)
	]
)