...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230414101841.xcframework.zip",
			checksum: "8f1f67b87a709d6fb741f3273295bc79c6e4582ea38cb126aa56bb3441adcf92"
		)
	]
)