...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/releases/GXFoundation-1.1.0-rc.1.xcframework.zip",
			checksum: "ce1703c41426023d9fabf6eabd168881390a6302cd2f3289d173f2fd3bef3cc4"
		)
	]
)