...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230217024255.xcframework.zip",
			checksum: "d794f05c544ce332053fea01fb77ca472eeae6e8a0e67755b20bd2f5f72e133a"
		)
	]
)