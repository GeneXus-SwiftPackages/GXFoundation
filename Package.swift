...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "c31c452298c853fb7df94094e69e28488af7a22ff424fee2bc9ce14f1c82ddb1"
		)
	]
)