...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "03808bcc9f7d477eabc651c08cde33ccb83bf36d2592ce1312b4dc02bc2c43e9"
		)
	]
)