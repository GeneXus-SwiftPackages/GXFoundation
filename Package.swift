...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "2b9530182ec7c6c045ad6d05c151dcd51da001d51996476f688047ac2dbe3671"
		)
	]
)