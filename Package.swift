...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230515020747.xcframework.zip",
			checksum: "dbae4b0a1e6077061b547336f43800ecbbc9a1dbf81179bc97ed99441d3834e2"
		)
	]
)