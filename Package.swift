...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230411173940.xcframework.zip",
			checksum: "8c538fe763f47faaa37f646dc53efe15c75e911e6bc5f9a8ea79d60de623301a"
		)
	]
)