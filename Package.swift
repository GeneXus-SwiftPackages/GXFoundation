...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230509202229.xcframework.zip",
			checksum: "835ece55b671d1b607d5cbc4a10e3096889521961c742e4f35cdcde6f6f5bf6b"
		)
	]
)