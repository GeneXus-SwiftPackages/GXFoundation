...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.794.xcframework.zip",
			checksum: "aa5cc5cfe582af59d7a1f7ccb46d310f6e4c8abc278bf1c005b420bf359b223e"
		)
	]
)