...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230306135613.xcframework.zip",
			checksum: "010e7a243fb2831d3950c2b2c7a413286b5fe43861080ada92855c5fc3d6c302"
		)
	]
)