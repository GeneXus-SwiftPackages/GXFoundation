...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "92cc4ffb8fdca155dabd2507c27b74816a8b4e70dfda414d0586a37ae5ed685b"
		)
	]
)