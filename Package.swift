...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309100338.xcframework.zip",
			checksum: "766aeb606e8811703385a6248d426901c2a6f9f666995b8063b18e4041164f34"
		)
	]
)