...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309171424.xcframework.zip",
			checksum: "a3489a2697fb896000bb5fedbafdfce19f1ad7353016b4e5c65d4f8b11215e85"
		)
	]
)