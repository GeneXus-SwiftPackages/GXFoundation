...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230721115743.xcframework.zip",
			checksum: "cab09dedd3e30aeadc9fe3bde98b7ae8fb6d1f14ef0a0085cad44616d36edc90"
		)
	]
)