...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230515153434.xcframework.zip",
			checksum: "e00b9b2c804d68953ccc5b7e2a93ec0772018605d11172e6e3f3ecfb39513c76"
		)
	]
)