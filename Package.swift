...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230630183632.xcframework.zip",
			checksum: "afb4b01e02363d23a1d9b55fddc755e2edc509431d4a5918af0d47efaabe0cce"
		)
	]
)