...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230321182636.xcframework.zip",
			checksum: "05218e9c0ce766964f34e90e7da64fcd346f71df9767fff6e1a988d3c8d623dd"
		)
	]
)