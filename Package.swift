...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230505145632.xcframework.zip",
			checksum: "de3ae744144cfc6c5bbe89c886e57294b1a059709f2adaec579e5ca0d16d54fe"
		)
	]
)