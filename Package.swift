...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230707153504.xcframework.zip",
			checksum: "18dc34d26be14b4f6b9975dbc24ed12a3eb2c511d481e7980dc8f2ede427a45a"
		)
	]
)