...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230315120127.xcframework.zip",
			checksum: "4571f34e0231b196eb7f0c0966e4b93e1f4a69b8597c6cbf456b99140ad69a34"
		)
	]
)