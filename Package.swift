...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309092859.xcframework.zip",
			checksum: "69361be64b7289479bdd02786090b1fd81584e0f29f7fee2230c61874792d9a6"
		)
	]
)