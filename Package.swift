...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFoundation-1.1.0-rc.5.xcframework.zip",
			checksum: "961113874e5ecaa52e0bc9e5da5a4672ea72ce6f7fcf341f66fc03e157a3250c"
		)
	]
)