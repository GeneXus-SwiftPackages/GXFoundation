...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230515174624.xcframework.zip",
			checksum: "9744a654d4872900bde6c1f3b7c082dcb7d655a62a3ad6a5d90fb74379f1a519"
		)
	]
)