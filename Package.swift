...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230307184249.xcframework.zip",
			checksum: "b0a49e31a440ce015e8f98c4868af4a7d8a098aeaef6135110092c8701386eb7"
		)
	]
)