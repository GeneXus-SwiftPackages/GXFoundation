...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309142042.xcframework.zip",
			checksum: "6acc806b66d245c2fce377e67c1de68a0964f642bd2dc7f77f9836be511722b2"
		)
	]
)