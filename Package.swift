...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230707201252.xcframework.zip",
			checksum: "37124444235f16978672196c468a0c7739e5579cdd89f3248739dc45c777334a"
		)
	]
)