...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230724135409.xcframework.zip",
			checksum: "daa93fab2ee91719ec8dcee53cfe79db0a846810d9e946698c5d4c7187a31e9e"
		)
	]
)