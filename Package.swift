...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230327200102.xcframework.zip",
			checksum: "800e6d6ac699e569fd5737d3faa7064e1187294a033f09cc5572b2cab03381ae"
		)
	]
)