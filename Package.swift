...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230620165651.xcframework.zip",
			checksum: "00dff6adaf9188938dd61080e471ce4e943c7fb85aa567c0a0138b7aff6cb3df"
		)
	]
)