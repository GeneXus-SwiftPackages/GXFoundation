...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230428153652.xcframework.zip",
			checksum: "cedb8fded69da4e5dc4fd0a4e0bf0fa2e37a7f9d64cb8b671d3c326456ccb4ed"
		)
	]
)