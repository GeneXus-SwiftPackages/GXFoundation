...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230613192339.xcframework.zip",
			checksum: "9719873d79f53b385e60974e5bfcbe75b4f5d591417b84dd8479ec966343ef9a"
		)
	]
)