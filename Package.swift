...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.10.xcframework.zip",
			checksum: "1b3bdc92b0301dc3121a39861241408b7994adaea21c101c612a1a7aed3128ba"
		)
	]
)