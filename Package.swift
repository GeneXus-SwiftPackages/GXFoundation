...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230526182522.xcframework.zip",
			checksum: "2bdcacc1169813d685586895eab4ad7f0bcc6f11fc69220fbc59d0cbafd0452b"
		)
	]
)