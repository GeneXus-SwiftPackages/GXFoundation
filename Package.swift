...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.9.xcframework.zip",
			checksum: "2d6d7d5d70fbed997d8fef15caa5948bd41cb0e5dc27f21c2cbe6a9e896b2754"
		)
	]
)