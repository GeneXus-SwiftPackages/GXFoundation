...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230610052334.xcframework.zip",
			checksum: "a3f3e823413995eda63540df04b6217203ab02f0ab52b7e144659ea12d204fba"
		)
	]
)