...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFoundation-1.0.0-preview.20230714192150.xcframework.zip",
			checksum: "6af18e044580eef1fcae7c5c2ffbf8435cbaf43014315c084a503f7e3f25f7a0"
		)
	]
)