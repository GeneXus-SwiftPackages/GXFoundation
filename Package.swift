...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230726144822.xcframework.zip",
			checksum: "ed1d5de477f04a05a48320f6cf0abee77ef5cc74f7b49e55ce8711bc44db83b9"
		)
	]
)