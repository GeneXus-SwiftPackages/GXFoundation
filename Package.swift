...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230721123914.xcframework.zip",
			checksum: "0dc6185a01ffbca3a6c1fe54c69740cef2dd6da87f0cbc79317e56801cd6c58f"
		)
	]
)