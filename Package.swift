...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "6ba96085c81a3e0913db3029fbdf94c9504f8420d431940d511f4e1b450cffe3"
		)
	]
)