...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230315133647.xcframework.zip",
			checksum: "3430a237bc8d785e7a35fbab66b6e08f48c651288632e7392d3fa505650e0a8d"
		)
	]
)