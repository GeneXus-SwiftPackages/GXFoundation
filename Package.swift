...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230503140111.xcframework.zip",
			checksum: "159afb4e289e882e981505352bed86777f475c4a1ff39ac3616920aa31003e0c"
		)
	]
)