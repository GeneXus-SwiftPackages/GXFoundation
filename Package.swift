...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230505132240.xcframework.zip",
			checksum: "d8e62e63d5015a5a8f40a8f6ac39a05de1bdf23e9aec2c66b143278caab018dd"
		)
	]
)