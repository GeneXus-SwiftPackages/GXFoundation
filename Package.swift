...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230623154354.xcframework.zip",
			checksum: "1f2d4123d745443a7ab63b4d9a16573e9e079648decba07a47384fe7a7ed5a37"
		)
	]
)