...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "227fbe1b65e0143b1360a44e8e17fbf3c0b8744a9a83d92bf7ffe7033fa0df2a"
		)
	]
)