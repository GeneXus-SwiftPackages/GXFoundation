...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230519205149.xcframework.zip",
			checksum: "040ca210cb01ed5cbf7a95393a2d1a93bdfdb5d05dc525985d7381a4a14cfd1d"
		)
	]
)