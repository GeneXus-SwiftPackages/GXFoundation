...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "a3c091d3ef23d8c11c6066338c15d0d67e998913c57bd50fe2105a8e1292e1ca"
		)
	]
)