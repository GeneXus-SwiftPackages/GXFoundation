...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/preview/GXFoundation-1.1.0-rc.4.xcframework.zip",
			checksum: "570f89f8762629ea028b9d0f106ad8f3226bd5056c12c2060ff15b457ff459fa"
		)
	]
)