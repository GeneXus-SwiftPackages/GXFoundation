...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230316174639.xcframework.zip",
			checksum: "7779354ad6bd280c10066ab450283016a12d87908922a0775ad5432733476b4a"
		)
	]
)