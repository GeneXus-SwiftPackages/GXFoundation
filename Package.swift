...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230714111921.xcframework.zip",
			checksum: "3b13e982ac952eeca7c2fd2e035fc85e99a66d0b6777a073e3dda8ecc493dae9"
		)
	]
)