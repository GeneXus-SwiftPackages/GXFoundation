...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230424185248.xcframework.zip",
			checksum: "2997e6867c61991d5b9d5e99a8c7d4b913e402835621e78a0ae8325b0fd7803a"
		)
	]
)