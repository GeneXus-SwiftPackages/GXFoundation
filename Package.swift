...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230706165352.xcframework.zip",
			checksum: "197abfe113c74ec84f8bdc9cc714da4ce65c63010409aa77794a687e75accb0e"
		)
	]
)