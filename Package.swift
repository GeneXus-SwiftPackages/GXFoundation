...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230405133406.xcframework.zip",
			checksum: "5825cd5ccf211e5a700516a1f5d35b4dd97efee9b0efddd25c85aebbbb50e5e6"
		)
	]
)