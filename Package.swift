...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "2715e9dba5fa2819fdbe08a9c6843cffda3a670501a75d3c32137eb3aea90a7e"
		)
	]
)