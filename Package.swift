...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.6.xcframework.zip",
			checksum: "5de5833bc88393306369f4477a04a81df12f9a4a9ceb7d8a574cd402c15b0b93"
		)
	]
)