...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230306150353.xcframework.zip",
			checksum: "c8cd2a13587bdbda57507b0a1354238660fabdab84692330ec2c613fb34d26fd"
		)
	]
)