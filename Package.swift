...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.8.xcframework.zip",
			checksum: "6cf509a292be81db3ecb1e1d1facfe57d4a3373f9319e4b6c24d3e686a990df1"
		)
	]
)