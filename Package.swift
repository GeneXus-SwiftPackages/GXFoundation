...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.1.0-beta.795.xcframework.zip",
			checksum: "bcc25f7f708f32ebbad5569204cb0b4621b26fa5425f8c4e64e560e9dd0a4c94"
		)
	]
)