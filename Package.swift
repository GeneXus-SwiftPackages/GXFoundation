...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "91c29ae3afb2f5e603a96a957ac001bf086cfb0d00a072761868384c99567772"
		)
	]
)