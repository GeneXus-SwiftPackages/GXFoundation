...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230519182256.xcframework.zip",
			checksum: "6741609b77fd3353dc0770d32382efee9c99f4a976bcf05ffb7474ce46063b2b"
		)
	]
)