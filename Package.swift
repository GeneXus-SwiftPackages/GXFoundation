...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230314121632.xcframework.zip",
			checksum: "fe76f43affe1b9e093470157f9100236c68eef1a5d35ab30c9c0fc9d9369c941"
		)
	]
)