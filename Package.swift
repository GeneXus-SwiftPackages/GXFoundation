...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230609175617.xcframework.zip",
			checksum: "dfe96dd4ff6157f3a955123d3511643477b9e412661cd218475cbd76c3ecf081"
		)
	]
)