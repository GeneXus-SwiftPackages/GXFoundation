...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230711133237.xcframework.zip",
			checksum: "b4e7ad23573e575d7bbd216e71aba746f24c14dbd18233089d2e84a3e011bf3f"
		)
	]
)