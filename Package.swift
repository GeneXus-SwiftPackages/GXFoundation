...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230309134517.xcframework.zip",
			checksum: "c65c696fd238c61794b4526f78435013f59f01cac1f5c688c21706a87962a815"
		)
	]
)