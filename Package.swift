...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230630204809.xcframework.zip",
			checksum: "be6283c74bd78ee3339ecb70e89fcb806810e459968776b8cb61a310eba41b9b"
		)
	]
)