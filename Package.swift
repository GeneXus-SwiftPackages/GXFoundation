...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta.20230704132152.xcframework.zip",
			checksum: "b8016854e9dcae59d7b76f86650e77d4eac45989fb8fbd7757a34eb896cd3b13"
		)
	]
)