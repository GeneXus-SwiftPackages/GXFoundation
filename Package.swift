...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230217195542.xcframework.zip",
			checksum: "998ed7209e39282ee29e79e4166603981bc5fff6a7587809dc293fb7e3215029"
		)
	]
)