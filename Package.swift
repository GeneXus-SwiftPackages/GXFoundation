...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXFoundation",
			url: "https://pkgs.genexus.dev/iOS/beta/GXFoundation-1.0.0-beta+20230306155445.xcframework.zip",
			checksum: "85f47b31cc28dfa14e528595103f1f1dcae1ad41f6189a5164f5dea27aa5f16b"
		)
	]
)